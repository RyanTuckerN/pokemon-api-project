...
const image = document.querySelector("#pokemon-sprite");
const title = document.querySelector("h3");
const info1 = document.querySelector("#pokemon-info-1");
...
async function pokeFetch(pokemonName) {
  ...
  info3.innerHTML = "<strong>Example move 1:</strong> " + move1.toUpperCase();
  info4.innerHTML = "<strong>Example move 2:</strong> " + move2.toUpperCase();
}
...
autocomplete(document.getElementById("myInput"), pokeNameArr);

//event listeners for search field
